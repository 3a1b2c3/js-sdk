...
wsl -e bash -lc "cd /mnt/c/workspace/world/REACTOR_js-sdk/local_server && LINGBOT_FRAME_TAP=/mnt/c/workspace/world/REACTOR_js-sdk/coordinator/frame.png /home/kschmid/lingbot-venv/bin/python server.py --port 8080 %ARGS%"
endlocal
